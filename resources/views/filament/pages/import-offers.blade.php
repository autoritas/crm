    ...
    <form wire:submit="import" class="space-y-6">
        <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-gray-400 mt-1">Columnas esperadas: codigo_proyecto, cliente, proyecto, objeto, sector, tipo_licitacion, fecha_presentacion, importe_licitacion, importe_estimado, duracion_meses, estado, temperatura</p>
        ...
        <div class="mt-6 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="rounded-lg bg-green-50 p-4 dark:bg-green-900/20">
                    ...
                    <p class="text-sm text-green-700 dark:text-green-400">Ofertas importadas</p>
                </div>
                <div class="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                    <span class="text-2xl font-bold text-red-600">{{ $skipped }}</span>
                    <p class="text-sm text-red-700 dark:text-red-400">Omitidas</p>
                </div>
            </div>
